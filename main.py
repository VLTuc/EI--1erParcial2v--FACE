...
def hacer_pregunta(pregunta):
    ...
    contexto1 = extraer_texto_y_formulas("resumen 1er Parcial.pdf")
    contexto2 = extraer_texto_y_formulas("Teoria Primer Parcial.pdf")
    contexto_completo = f"Resumen de la materia:\n{contexto1}\n\n Explicación de algunos puntos abordados en la teoria:\n{contexto2}\n"

    # Mensajes para el modelo
    mensajes = [
        ChatMessage(role="system", content=(
            "Eres un profesor de estadística, responde siempre en español."
